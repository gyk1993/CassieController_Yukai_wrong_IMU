...
%          
      ...
      if obj.stanceLeg == 1 % right stance
          GaitParams = obj.ControlParams.RightStance;
      else
          GaitParams = obj.ControlParams.LeftStance;
      end
    ...
    function [out, Data, ControlParams] = getOutputSizeImpl(~)
    ...
    function [out, Data, ControlParams] = getOutputDataTypeImpl(~)
    %GETOUTPUTDATATYPEIMPL Get data types of output ports.
      out = 'cassieInputsBus';
      Data = 'cassieDataBus';
      ControlParams = 'cassieControlParamsBus';
    end % getOutputDataTypeImpl
    
    function [out, Data, ControlParams]  = isOutputComplexImpl(~)
    ...
    function [out, Data, ControlParams]  = isOutputFixedSizeImpl(~)
